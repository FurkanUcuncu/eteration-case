...
const initialState = { products: mockProduct, allProducts: mockProduct, favorites: [], cart: [], isLoading: false };
...
describe('Product slice tests', () => {
    ...
    it('Filter call', async () => {
        store.dispatch(filterProducts({ minPrice: "3", maxPrice: "10", model: "test" }));
