...
const FilterDialog: React.FC<{ visible: boolean; hideDialog: () => void }> = ({
  visible,
  hideDialog,
}) => {
    ...
    <Portal>
      <Dialog test-id="dialog" visible={visible} onDismiss={hideDialog}>
        <Dialog.ScrollArea style={styles.dialogScrollArea}>
          ...
          <Dialog.Actions>
            <Button testID="reset-filters-button" onPress={handleReset}>
              Reset
            </Button>
            <Button testID="apply-filters-button" onPress={handlePriceFilter}>
              Ok
            </Button>
          </Dialog.Actions>
        </Dialog.ScrollArea>
